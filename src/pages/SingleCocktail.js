  ...
  React.useEffect(()=>{
    ...
    async function getCocktail(){
      try{
        ...
        if(data.drinks){
          const {strDrink:name, strDrinkThumb:image,strCategory:category, strGlass:glass, strAlcoholic:info,strInstructions:instructions, strIngredient1,strIngredient2,strIngredient3,strIngredient4,strIngredient5,strIngredient6,strIngredient7,strIngredient8,strIngredient9,strIngredient10,strIngredient11, strIngredient12,strIngredient13,strIngredient14,strIngredient15} = data.drinks[0]
    ...
    return(
      <section className="section cocktail-section">
        ...
        <div className="drink-info">
          ...
          <p>Ingredients : {
            ingredients.map((ingredient,idx)=>ingredient? <span key={idx}> {ingredient}</span> : null)
            }
          </p>
        </div>
